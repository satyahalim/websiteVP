...
<head>
    ...
    <style>
        ...
        .stat-item:nth-child(1) { background: linear-gradient(135deg, #69bae2, #0e86d3); color: white; }
        .stat-item:nth-child(2) { background: linear-gradient(135deg, #69bae2, #0e86d3); color: white; }
        .stat-item:nth-child(3) { background: linear-gradient(135deg, #69bae2, #0e86d3); color: white; }
        ...
        .gallery-item:nth-child(2n) {
            background: linear-gradient(45deg, #69bae2, #0e86d3);
        }
        ...
        <div class="container">
            ...
            <div class="achievements-grid">
                <div class="achievement-card card-animate">
                    ...
                    <div class="achievement-title">1st Place Traditional Music Category</div>
                    <div class="achievement-desc">Winner of Category di International Bandung Choral Festival 2024</div>
                </div>
                <div class="achievement-card card-animate">
                    <div class="achievement-icon">🥈</div>
                    <div class="achievement-title">2nd Place Pop & Jazz Category</div>
                    <div class="achievement-desc">Meraih Posisi Kedua di Bali International Choral Festival 2022</div>
                </div>
                <div class="achievement-card card-animate">
                    <div class="achievement-icon">🥉</div>
                    <div class="achievement-title">3rd Place Folklore Category</div>
                    <div class="achievement-desc">Meraih Posisi Ketiga di Thailand International Choral Festival 2024</div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    <img src="image/gale1.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale2.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale3.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale4.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale5.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale6.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale7.JPG" alt="">
                </div>
                <div class="gallery-item">
                    <img src="image/gale8.JPG" alt="">
                </div>
            </div>
